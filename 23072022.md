...
<img width="380" alt="스크린샷 2022-07-24 15 20 42" src="https://user-images.githubusercontent.com/92393851/180648871-5b50aa97-d1e8-4a73-8fb9-9db73f78852a.png">
  ...
  - package.json : express 관련 내용이 여기 들어있으면 정상적으로 설치
  - package-lock.json : 어떤 패키지들이 어떤 버전으로 설치되었는지 기록, 다른 동료들과 협업할 때 같은 환경으로 개발 가능
  - node_modules : npm을 통해 설치된 패키지들에 대한 파일이 설치되는 곳
